#!/bin/bash
# Execution of TALON to generate the long-read transcriptome reconstructed with ONT
...
talon_label_reads \
	--f ~/TFM_pipelines/sim_data/wtc11_ont_sample_diff_complex/ONT_simulated.aln.sam \
...
# Running TALON
talon \
	--f ~/TFM_pipelines/talon_pipeline/talon_wtc11_ont/config_file.csv \
	--db ~/TFM_pipelines/talon_pipeline/talon_wtc11_ont/hs_talon_db.db \
...
talon_create_GTF \
	--db ~/TFM_pipelines/talon_pipeline/talon_wtc11_ont/hs_talon_db.db \
	--whitelist ~/TFM_pipelines/talon_pipeline/talon_wtc11_ont/talon_isofilter.csv \
...
python sqantisim.py eval \
	--isoforms ~/TFM_pipelines/talon_pipeline/talon_wtc11_ont/talon_transcriptome_talon.gtf \
	...
	-o talon_wtc11_ont -d ~/TFM_pipelines/talon_pipeline/talon_wtc11_ont/sqanti3 \
